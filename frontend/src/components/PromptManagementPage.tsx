...
export default function PromptManagementPage() {
  ...
  const [testInputs, setTestInputs] = useState('{\n  "input_text": "这里是一段测试文本",\n  "ocr_result": "",\n  "label_schema": "doc_title, paragraph_title, text, table_of_contents, table, formula, chart, flowchart, diagram, image, caption, vision_footnote, header, footer, handwriting, seal"\n}');
